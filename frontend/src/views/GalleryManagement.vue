<template>
  <div class="gallery-management container py-5">
    <h2 class="text-center mb-4 text-dark">Gallery Management</h2>
    <div class="row justify-content-center">
      <div class="col-md-8">
        <form 
          @submit.prevent="addGalleryItem" 
          enctype="multipart/form-data" 
          class="p-4 border rounded bg-white shadow-lg"
        >
          <!-- Gallery Name -->
          <div class="mb-3">
            <label for="name" class="form-label text-dark">Gallery Name</label>
            <input 
              type="text" 
              id="name" 
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-primary w-100 shadow-sm border-0 rounded-pill py-2">
              Add Gallery Item
            </button>
          </div>
        </form>
