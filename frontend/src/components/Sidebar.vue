<template>
  <aside :id="sidebarId" :class="{ expand: sidebarExpanded }">
    ...
    <ul class="sidebar-nav">
      ...
      <li class="sidebar-item">
        <a href="#" class="sidebar-link" @click="toggleEventNewsDropdown">
          <i class="lni lni-protection"></i>
          <span>Event and News Management</span>
        </a>
        <ul v-if="isEventNewsOpen" class="sidebar-dropdown list-unstyled">
          <li class="sidebar-item">
      ...
      <!-- New "Accounts" Button -->
      <li class="sidebar-item">
        <a href="#" class="sidebar-link" @click="toggleAccountsDropdown">
          <i class="lni lni-cog"></i>
          <span>Accounts</span>
        </a>
        <ul v-if="isAccountsOpen" class="sidebar-dropdown list-unstyled">
          <li class="sidebar-item">
            <a href="#" class="sidebar-link" @click="loadPage('/adminaccounts')">Manage Accounts</a>
          </li>
          <li class="sidebar-item">
            <a href="#" class="sidebar-link" @click="loadPage('/adminusers')">Manage Users</a>
          </li>
        </ul>
      </li>
      ...
      <li class="sidebar-item">
        <a href="#" class="sidebar-link" @click="loadPage('/viewreview')">
          <i class="lni lni-comments"></i>
          <span>View Reviews</span>
        </a>
      </li>

      <!-- New Sidebar Item for Booking Management -->
      <li class="sidebar-item">
        <a href="#" class="sidebar-link" @click="loadPage('/admin-bookingmanagement')">
...
export default {
  data() {
    return {
      ...
      isManagementOpen: false, // Controls the dropdown visibility for Collection Management
      isEventNewsOpen: false, // Controls the dropdown visibility for Event and News Management
      isAccountsOpen: false, // Controls the dropdown visibility for Accounts
    };
  },
  computed: {
    sidebarId() {
  ...
  methods: {
    ...
    toggleManagementDropdown() {
      this.isManagementOpen = !this.isManagementOpen; // Toggle Collection Management dropdown visibility
    },
    toggleEventNewsDropdown() {
      this.isEventNewsOpen = !this.isEventNewsOpen; // Toggle Event and News Management dropdown visibility
    },
    toggleAccountsDropdown() {
      this.isAccountsOpen = !this.isAccountsOpen; // Toggle Accounts dropdown visibility
    },
    loadPage(page) {
